...
export const projects: Project[] = [
    {
        ...
        mediaType: "video",
        mediaUrl: `${import.meta.env.BASE_URL}Car_Animation/Render.mp4`,
        gallery: [
    ...
    },
    {
        ...
        gallery: [
            ...
            { url: `${import.meta.env.BASE_URL}Hacker_Environment/Geometry_nodes.png`, caption: "Geometric Nodes" },
            { url: `${import.meta.env.BASE_URL}Hacker_Environment/Wireframe.png`, caption: "Wireframe View" },
            { url: `${import.meta.env.BASE_URL}Hacker_Environment/Material.png`, caption: "Material Setup" }
        ],
        featured: false
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}NCC Web-app/Home.png`,
        imageGradient: "from-green-900 via-emerald-900 to-black",
        mediaType: "video",
        mediaUrl: `${import.meta.env.BASE_URL}NCC Web-app/Hero vedio.mp4`,
        link: "https://ganesh4502.github.io/Ganesh_NCC/",
        github: "https://github.com/ganesh4502/Ganesh_NCC",
        gallery: [
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Home.png`, caption: "Home Page" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/About Page.png`, caption: "About Page" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Events page - admin.png`, caption: "Events Admin Panel" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Login Page.png`, caption: "Login Page" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Notes page - admin.png`, caption: "Notes Admin Panel" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Rankers details page.png`, caption: "Rankers Details" },
            { url: `${import.meta.env.BASE_URL}NCC Web-app/Test page - admin.png`, caption: "Test Admin Panel" }
        ],
        featured: true
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}paradox/paradox_thumbnail.png`, // User provided thumbnail
        imageGradient: "from-red-900 via-orange-900 to-black",
        mediaType: "video",
        mediaUrl: `${import.meta.env.BASE_URL}paradox/paradox_title_original.mp4`,
    ...
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}Sci-fi Environment/render.png`, // Rendered Image Main
        imageGradient: "from-purple-900 via-fuchsia-900 to-black",
        mediaType: "gallery",
        gallery: [
            { url: `${import.meta.env.BASE_URL}Sci-fi Environment/render.png`, caption: "Rendered Image" },
            { url: `${import.meta.env.BASE_URL}Sci-fi Environment/raw.png`, caption: "Raw Image" },
            { url: `${import.meta.env.BASE_URL}Sci-fi Environment/geomentry.png`, caption: "Geometric Nodes" },
            { url: `${import.meta.env.BASE_URL}Sci-fi Environment/wireframe.png`, caption: "Wireframe View" },
            { url: `${import.meta.env.BASE_URL}Sci-fi Environment/material.png`, caption: "Material Setup" }
        ],
        featured: false
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}OTT Platform UI/hero image.png`,
        mediaType: "video",
        mediaUrl: `${import.meta.env.BASE_URL}OTT Platform UI/Hero Vedio.mp4`,
    ...
    },
    {
        ...
        tools: ["Canva"],
        image: `${import.meta.env.BASE_URL}Canva_Edits/Hero_image.png`,
        imageGradient: "from-blue-600 via-purple-600 to-black",

        mediaType: "gallery",
        gallery: [
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Dusshera.png`, caption: "Dusshera Poster" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Ganesh Chaturthi.png`, caption: "Ganesh Chaturthi Poster" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Indian NAVY day.png`, caption: "Indian NAVY Day" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Milad UN-Nabi.png`, caption: "Milad UN-Nabi" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/NATIONAL UNITY DAY (2).png`, caption: "National Unity Day" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/National Sports day.png`, caption: "National Sports Day" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/October-2nd.png`, caption: "October 2nd" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Onam.png`, caption: "Onam Poster" },
            { url: `${import.meta.env.BASE_URL}Canva_Edits/Sovenier Index.png`, caption: "Sovenier Index" }
        ],
        featured: false
    },
    {
        ...
        tools: ["Canva"],
        image: `${import.meta.env.BASE_URL}paradox/paradox_thumbnail.png`,
        imageGradient: "from-orange-900 via-red-900 to-black",
        mediaType: "gallery",
        youtubeChannelUrl: "https://www.youtube.com/@KV_Productions-F4",
        gallery: [
            { url: `${import.meta.env.BASE_URL}paradox/paradox_thumbnail.png`, caption: "Paradox - Movie Title Design" }
        ],
        featured: false
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}Internship/Home page.png`,
        imageGradient: "from-indigo-900 via-blue-900 to-black",
        mediaType: "video",
        mediaUrl: `${import.meta.env.BASE_URL}Internship/Hero%20Vedio.mp4`,
        gallery: [
            { url: `${import.meta.env.BASE_URL}Internship/Home page.png`, caption: "Home Page" },
            { url: `${import.meta.env.BASE_URL}Internship/Home - Light mode.png`, caption: "Home Page - Light Mode" },
            { url: `${import.meta.env.BASE_URL}Internship/About Setion 1.png`, caption: "About Section - 1" },
            { url: `${import.meta.env.BASE_URL}Internship/About Section 2.png`, caption: "About Section - 2" },
            { url: `${import.meta.env.BASE_URL}Internship/Works section - 1.png`, caption: "Works Section - 1" },
            { url: `${import.meta.env.BASE_URL}Internship/Works Section - 2.png`, caption: "Works Section - 2" },
            { url: `${import.meta.env.BASE_URL}Internship/Skills gained.png`, caption: "Skills Gained" }
        ],

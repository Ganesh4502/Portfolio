...
export const projects: Project[] = [
    {
        ...
        image: "/Car_Animation/Raw.png",
        imageGradient: "from-slate-800 via-gray-900 to-black",
        mediaType: "video",
        mediaUrl: "/Car_Animation/Render.mp4",
        gallery: [
            { url: "/Car_Animation/Raw.png", caption: "Raw Image" },
            { url: "/Car_Animation/Geomentry_nodes.png", caption: "Geometry Nodes Setup" },
            { url: "/Car_Animation/Material.png", caption: "Material Setup" },
            { url: "/Car_Animation/Wireframe.png", caption: "Wireframe View" }
        ],
        featured: true
    },
    {
        ...
        image: "/Hacker_Environment/Rendered.png", // Rendered Image Main
        imageGradient: "from-cyan-900 via-blue-900 to-black",
        mediaType: "gallery",
        gallery: [
            { url: "/Hacker_Environment/Rendered.png", caption: "Rendered Image" },
            { url: "/Hacker_Environment/Raw.png", caption: "Raw Image" },
            { url: "/Hacker_Environment/Geometry_nodes.png", caption: "Geometric Nodes" },
            { url: "/Hacker_Environment/Wireframe.png", caption: "Wireframe View" },
            { url: "/Hacker_Environment/Material.png", caption: "Material Setup" }
        ],
        featured: false
    },
    {
        ...
        image: "/NCC Web-app/Home.png",
        imageGradient: "from-green-900 via-emerald-900 to-black",
        mediaType: "video",
        mediaUrl: "/NCC Web-app/Hero vedio.mp4",
        link: "https://ganesh4502.github.io/Ganesh_NCC/",
        github: "https://github.com/ganesh4502/Ganesh_NCC",
        gallery: [
            { url: "/NCC Web-app/Home.png", caption: "Home Page" },
            { url: "/NCC Web-app/About Page.png", caption: "About Page" },
            { url: "/NCC Web-app/Events page - admin.png", caption: "Events Admin Panel" },
            { url: "/NCC Web-app/Login Page.png", caption: "Login Page" },
            { url: "/NCC Web-app/Notes page - admin.png", caption: "Notes Admin Panel" },
            { url: "/NCC Web-app/Rankers details page.png", caption: "Rankers Details" },
            { url: "/NCC Web-app/Test page - admin.png", caption: "Test Admin Panel" }
        ],
        featured: true
    },
    {
        ...
        image: "/paradox/paradox_thumbnail.png", // User provided thumbnail
        imageGradient: "from-red-900 via-orange-900 to-black",
        mediaType: "video",
        mediaUrl: "/paradox/paradox_title_original.mp4",
    ...
    },
    {
        ...
        image: "/Sci-fi Environment/render.png", // Rendered Image Main
        imageGradient: "from-purple-900 via-fuchsia-900 to-black",
        mediaType: "gallery",
        gallery: [
            { url: "/Sci-fi Environment/render.png", caption: "Rendered Image" },
            { url: "/Sci-fi Environment/raw.png", caption: "Raw Image" },
            { url: "/Sci-fi Environment/geomentry.png", caption: "Geometric Nodes" },
            { url: "/Sci-fi Environment/wireframe.png", caption: "Wireframe View" },
            { url: "/Sci-fi Environment/material.png", caption: "Material Setup" }
        ],
        featured: false
    },
    {
        ...
        image: "/OTT Platform UI/hero image.png",
        mediaType: "video",
        mediaUrl: "/OTT Platform UI/Hero Vedio.mp4",
    ...
    },
    {
        ...
        tools: ["Canva"],
        image: "/Canva_Edits/Hero_image.png",
        imageGradient: "from-blue-600 via-purple-600 to-black",

        mediaType: "gallery",
        gallery: [
            { url: "/Canva_Edits/Dusshera.png", caption: "Dusshera Poster" },
            { url: "/Canva_Edits/Ganesh Chaturthi.png", caption: "Ganesh Chaturthi Poster" },
            { url: "/Canva_Edits/Indian NAVY day.png", caption: "Indian NAVY Day" },
            { url: "/Canva_Edits/Milad UN-Nabi.png", caption: "Milad UN-Nabi" },
            { url: "/Canva_Edits/NATIONAL UNITY DAY (2).png", caption: "National Unity Day" },
            { url: "/Canva_Edits/National Sports day.png", caption: "National Sports Day" },
            { url: "/Canva_Edits/October-2nd.png", caption: "October 2nd" },
            { url: "/Canva_Edits/Onam.png", caption: "Onam Poster" },
            { url: "/Canva_Edits/Sovenier Index.png", caption: "Sovenier Index" }
        ],
        featured: false
    },
    {
        ...
        tools: ["Canva"],
        image: "/paradox/paradox_thumbnail.png",
        imageGradient: "from-orange-900 via-red-900 to-black",
        mediaType: "gallery",
        youtubeChannelUrl: "https://www.youtube.com/@KV_Productions-F4",
        gallery: [
            { url: "/paradox/paradox_thumbnail.png", caption: "Paradox - Movie Title Design" }
        ],
        featured: false
    },
    {
        ...
        image: "/Internship/Home page.png",
        imageGradient: "from-indigo-900 via-blue-900 to-black",
        mediaType: "video",
        mediaUrl: "/Internship/Hero%20Vedio.mp4",
        gallery: [
            { url: "/Internship/Home page.png", caption: "Home Page" },
            { url: "/Internship/Home - Light mode.png", caption: "Home Page - Light Mode" },
            { url: "/Internship/About Setion 1.png", caption: "About Section - 1" },
            { url: "/Internship/About Section 2.png", caption: "About Section - 2" },
            { url: "/Internship/Works section - 1.png", caption: "Works Section - 1" },
            { url: "/Internship/Works Section - 2.png", caption: "Works Section - 2" },
            { url: "/Internship/Skills gained.png", caption: "Skills Gained" }
        ],
